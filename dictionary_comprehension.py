# dictionary comprehension = create dictionaries using an expression - создавать словари с помощью выражения
# can replace for loops and certain lambda functions - может заменить циклы for и некоторые лямбда-функции

# dictionary comprehension - понимание словаря
# celsius - цельсия
